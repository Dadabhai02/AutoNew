...
BOT_TOKEN = environ.get('BOT_TOKEN', '5843935085:AAFl-mXcEV_EbLRAK1vPAuOg0NVDB0wpONc')
# Bot settings
...
auth_channel = environ.get('AUTH_CHANNEL','-1002131317104')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Dadaxleech:Dadaxleech10@cluster0.eqswmh7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Dadaxleech")
...
HOW_TO_DOWNLOAD =  environ.get('HOW_TO_DOWNLOAD', 'https://t.me/DaDaXBhai/17')

AUTO_DELETE_SECONDS = int(environ.get('AUTO_DELETE_SECONDS', 100))

FILE_REQ_CHANNEL = int(environ.get('FILE_REQ_CHANNEL', LOG_CHANNEL))

SHORTNER_SITE =  environ.get('SHORTNER_SITE', 'hypershort.com') #Put Only Shortner Site domain don't put like this https://tnlink.in/

SHORTNER_API =  environ.get('SHORTNER_API', '4d8f020aa131267a0b88ff1fa47c2f11555eba85')
